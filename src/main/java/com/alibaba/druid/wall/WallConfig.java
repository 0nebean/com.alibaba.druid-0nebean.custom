...
public class WallConfig implements WallConfigMBean {
    ...
    private boolean             createFunctionAllow         = true;
    ...
    public boolean isCreateFunctionAllow() {
        return createFunctionAllow;
    }

    public void setCreateFunctionAllow(boolean createFunctionAllow) {
        this.createFunctionAllow = createFunctionAllow;
    }
    ...
    public void configFromProperties(Properties properties) {
        ...
        {
            Boolean createFunctionAllow = getBoolean(properties, "druid.wall.createFunctionAllow");
            if (createFunctionAllow != null) {
                this.setCreateFunctionAllow(createFunctionAllow);
            }
        }
        {
