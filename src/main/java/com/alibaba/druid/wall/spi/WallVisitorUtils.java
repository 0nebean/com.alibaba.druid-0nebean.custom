    ...
    public static void preVisitCheck(WallVisitor visitor, SQLObject x) {
        ...
        if (x instanceof SQLCommentStatement) {
            ...
            if (x instanceof SQLCreateFunctionStatement){
                allow = config.isCreateFunctionAllow();
            }
            ...
            denyMessage = null;
                ...
                x instanceof MySqlDeclareStatement
                || x instanceof SQLReturnStatement
                || x instanceof SQLIfStatement
                || x instanceof SQLWhileStatement
        ) {
            allow = true;
            errorCode = 0;
            denyMessage = null;
